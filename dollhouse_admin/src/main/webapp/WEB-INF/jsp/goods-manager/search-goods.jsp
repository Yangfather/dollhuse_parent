...
<body class="bodybg">
	...
	<div class="page">
		<div class="wrapper fn-clear">
			<div class="count-tit">
				<i class="iconfont">&#xe605;</i>
				<span class="title-con">商品查找</span>
			</div><hr>
			<div class="count-con">
				<div class="search-block mt20">
					<form id="searchForm" action="<%=path %>/admin/goodsManager/goodsSearch">
						<label>商品名称：</label>
				...
				<div class="tab-top">
					...
					<table class="counttable mt0" cellpadding="0" cellspacing="0" border="0" id="tab1">
						...
						<tbody id="tableDiv" url="<%=basePath%><%=path %>/admin/goodsManager/goodsSearch"></tbody>
					</table>
				</div>
			</div>
		</div>
