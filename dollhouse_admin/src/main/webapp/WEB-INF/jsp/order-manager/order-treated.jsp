    ...
    <div class="page">
        <div class="wrapper fn-clear">
	        <div class="count">
	                <div class="count-tit">
	                    <i class="iconfont">&#xe605;</i>
	                    <span class="title-con">玩具屋已处理订单</span>
	                </div>
	                <div class="count-con">
	                <div class="search-block mt20" style="float:left">
	                 <form id="searchForm" action="<%=path %>/system/search/treated" method="get">
	                 ...
	                 <div class="tab-top mt20">
                 	 <c:if test="${isAdmin}">
	                    ...
	                    <table class="counttable mt0" cellpadding="0" cellspacing="0" border="0" id="tab1">
	                        ...
	                        <tbody id="tableDiv" url="<%=basePath%><%=path %>/system/search/treated">
								<tr>
