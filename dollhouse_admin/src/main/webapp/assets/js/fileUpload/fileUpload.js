...
var uploadTools = {
    ...
    "getInitOption":function(uploadId){
        ...
        var initOption={
            "uploadId":uploadId,
            "uploadUrl":"public/admin/goodsInfo",//必须，上传地址
     ...
     * 上传文件
     */
    "uploadFile":function(opt,goodsName,type,price1,price2,color,desprtion,goodsTypes,goodsPrices){
    	alert("363"+goodsName,type,price1,price2,color,desprtion,goodsTypes,goodsPrices)
        ...
        formData.append("desprtion",desprtion);
        formData.append("goodsTypes",goodsTypes);
        formData.append("goodsPrices",goodsPrices);
...
var uploadEvent = {
     ...
     * @param opt
     */
    "selectFileChangeEvent":function(files,opt,goodsName,type,price1,price2,color,desprtion,goodsTypes,goodsPrices){
        uploadTools.addFileList(files,opt,goodsName,type,price1,price2,color,desprtion,goodsTypes,goodsPrices);
        uploadTools.cleanFilInputWithSelectFile(opt,goodsName,type,price1,price2,color,desprtion,goodsTypes,goodsPrices);
     ...
     * 上传文件的事件
     * */
    "uploadFileEvent":function(opt,goodsName,type,price1,price2,color,desprtion,goodsTypes,goodsPrices){
    	alert("565"+goodsName,type,price1,price2,color,desprtion,goodsTypes,goodsPrices)
        uploadTools.flushOpt(opt);
        if(opt.beforeUpload!=null&&(typeof opt.beforeUpload === "function")) {
            opt.beforeUpload(opt);
        }
        uploadTools.uploadFile(opt,goodsName,type,price1,price2,color,desprtion,goodsTypes,goodsPrices);
    },
    /**
     * 清除文件事件
     */
