...
import com.dollhouse.core.utils.serializer.SerializerUtil;
...
public class SecurityUtil {
	 ...
	 * @throws Exception
	 */
	public static String generateKey(TreeMap<String, Object> treeMap) throws Exception {
		return encrypt(encode(serialize(treeMap)).replaceAll(ENTER, ""));
	}
	...
	public static String encrypt(String plainText) throws Exception {
		...
		SecretKeySpec seckey = new SecretKeySpec(PropertiesUtil.getAesKey().getBytes(),"AES");
	...
	public static String decrypt(String cipherText) throws Exception {
		Cipher cipher = Cipher.getInstance("AES/ECB/PKCS5Padding");
		SecretKeySpec skey = new SecretKeySpec(PropertiesUtil.getAesKey().getBytes(), "AES");
